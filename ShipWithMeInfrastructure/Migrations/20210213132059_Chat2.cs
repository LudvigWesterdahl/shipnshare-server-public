        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<string>(type: "nvarchar(48)", nullable: false),
                    CreatedAtTimeZone = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LatitudePickupLocation = table.Column<double>(type: "float", nullable: false),
                    LongitudePickupLocation = table.Column<double>(type: "float", nullable: false),
                    OfferValueTitle = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    StoreOrProductUri = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ShippingCost = table.Column<decimal>(type: "decimal(38,6)", precision: 38, scale: 6, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Expires = table.Column<string>(type: "nvarchar(48)", nullable: false),
                    UserId = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    From = table.Column<string>(type: "nvarchar(48)", nullable: false),
                    To = table.Column<string>(type: "nvarchar(48)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "InternalNotificationMessages",
                columns: table => new
                {
                    LanguageCode = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    InternalNotificationId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    Message = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_InternalNotificationMessages", x => new { x.InternalNotificationId, x.LanguageCode });
                    table.ForeignKey(
                        name: "FK_InternalNotificationMessages_InternalNotifications_InternalNotificationId",
                        column: x => x.InternalNotificationId,
                        principalTable: "InternalNotifications",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
